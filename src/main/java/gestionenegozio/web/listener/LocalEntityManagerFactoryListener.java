package gestionenegozio.web.listener;
...
import gestionenegozio.service.RuoloService;
import gestionenegozio.service.UtenteService;
...
public class LocalEntityManagerFactoryListener implements ServletContextListener {
	...
	private void initAdminUserAndRuoli() throws Exception {
		...
		if (utenteServiceInstance.findByUsernameAndPassword("root", "root") == null) {
			Utente classicUser = new Utente("root", "root", "Fabio", "Gialli", new Date());
			classicUser.setStato(StatoUtente.ATTIVO);
			utenteServiceInstance.inserisciNuovo(classicUser);
			utenteServiceInstance.aggiungiRuolo(classicUser,
